...
public class FelizActivity extends Activity  implements ClickListener {
	...
	private void displayView(int position) {
		...
		case 1:
			...
			break;
		case 2:
			listFragment = new CheckInFragment();
			break;
		case 3:
